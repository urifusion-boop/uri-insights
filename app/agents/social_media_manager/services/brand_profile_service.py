...
class BrandProfileService:
    """
    Stores and retrieves the brand profile captured during onboarding.
    The profile is the single source of truth for brand context fed to
    every content generation and image generation call.
    """
    ...
    async def save(
        ...
        """Upsert the brand profile for a user."""
        now = datetime.utcnow()
    ...
    async def get(user_id: str, db: AsyncIOMotorDatabase) -> Dict[str, Any]:
        """Retrieve the brand profile for a user."""
